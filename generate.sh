...
GENERATED="${GOPATH}/src/github.com/artemskriabin/email-subscription-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/artemskriabin/email-subscription-svc/docs/web_deploy"
